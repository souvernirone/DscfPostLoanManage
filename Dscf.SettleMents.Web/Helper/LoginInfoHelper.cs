...
namespace Dscf.SettleMents.Web.Helper
{
    public class LoginInfoHelper
    {
        ...
        public static OperaterEntity Operater()
        {
            try
            {
                ...
                {
                    return client.GetOperaterInfoByCookie(jsonOperatorCookie, PlatformUtil.SettleMentPlat);
                }
            }
            catch (Exception ex)
            {
        ...
        public static IList<MenuEntity> GetCurrentMenuList()
        {
            ...
            try
            {
                using (DscfBIServerConractClient client = new DscfBIServerConractClient())
                {
                    return client.GetPlatformMenuListByOptId(jsonOperatorCookie, PlatformUtil.SettleMentPlat);
                }
            }
            catch (Exception ex)
            {
